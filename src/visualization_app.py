...
def run_visualization_app(
    ...
    scatter_default_y_variable="NRI v013",  # None = use second numeric column (or first if only one)
    # Scatter plot labels
    ...
    map_default_variable="NRI v013",  # None = use first numeric column
    ...
    app.layout = dbc.Container([
        ...
        html.Div(id='map-view', children=[
            ...
            ], style={'height': 'calc(100% - 35px)'}, className='g-0'),
            # Footnote below the entire map row
            html.Div(
                "The boundaries and names shown and the designations used on this map do not imply official endorsement or acceptance by the United Nations/UNDP.",
                style={
                    'fontSize': '12px',
                    'fontFamily': 'Arial',
                    'textAlign': 'center',
